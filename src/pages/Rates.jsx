...
const Rates = () => {
  ...
  const extras = [
    ...
    {
      name: "Villa Ground Floor",
      detail: "Private Villa Booking",
      price: "4500",
    },
      ...
      <div className="bg-white pt-28 pb-10 sm:pt-36 sm:pb-16 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Choose from our popular all-inclusive packages or customize your
            visit with session-based rates below.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Detailed Session Rates
            </h2>
            <p className="text-lg text-gray-600">
              Specific timing breakdowns for picnics and stays.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-10 mb-20">
            ...
            <div className="border border-gray-200 rounded-2xl p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-6">
                <div className="bg-gray-100 p-2 rounded-lg">
                  {detailedPicnic.withoutFood.icon}
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900">
                    {detailedPicnic.withoutFood.title}
                  </h3>
                  <p className="text-xs font-bold text-gray-500 uppercase tracking-wide">
                    {detailedPicnic.withoutFood.subtitle}
                  </p>
                </div>
              </div>
            ...
            <div className="border border-[#008DDA]/30 bg-blue-50/30 rounded-2xl p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-6">
                <div className="bg-blue-100 p-2 rounded-lg text-[#008DDA]">
                  {detailedPicnic.withFood.icon}
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900">
                    {detailedPicnic.withFood.title}
                  </h3>
                  <p className="text-xs font-bold text-[#008DDA] uppercase tracking-wide">
                    {detailedPicnic.withFood.subtitle}
                  </p>
                </div>
              </div>
              <div className="space-y-6">
          ...
          <div className="mb-20">
            ...
            <div className="grid md:grid-cols-2 xl:grid-cols-4 gap-6">
              {coupleStays.map((stay, idx) => (
                <div
                  key={idx}
                  className={`rounded-2xl p-6 border ${stay.highlight ? "bg-gray-900 text-white border-gray-900" : "bg-white text-gray-900 border-gray-200 hover:border-[#008DDA]"} transition-colors`}
                >
                  <h4 className="font-bold text-lg mb-1">{stay.title}</h4>
                  <p
                    className={`text-xs mb-6 ${stay.highlight ? "text-gray-400" : "text-gray-500"}`}
                  >
                    {stay.time}
                  </p>
                  <div className="flex justify-between items-end">
                    ...
                    <span
                      className={`text-2xl font-bold ${stay.highlight ? "text-[#008DDA]" : "text-[#008DDA]"}`}
                    >
                      ₹{stay.price}
                    </span>
                  </div>
            ...
            <div className="mt-6 bg-blue-50 p-4 rounded-xl flex gap-3">
              ...
              <p className="text-sm text-gray-700">
                <span className="font-bold">Stay Child Policy:</span> Kids up to
                5 years are complimentary. Kids above 5 years are chargeable.
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl p-8 text-white flex flex-col justify-center">
              ...
              <p className="text-gray-400 mb-6">
                We offer special discounts for schools, colleges, tuition
                classes, and large corporate groups.
              </p>
