...
const Locations = () => {
  ...
  if (loading) {
    return (
      <StateSection title="Our Locations" message="Loading locations..." />
    );
  }
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex flex-wrap items-center gap-3 mb-2">
                        ...
                        {/* Night Stay Badge */}
                        {groupLocations.some(
                          (loc) => loc.propertyDetails?.nightStay,
                        ) && (
                      ...
                      <div className="flex items-center gap-3 mt-2">
                        <span className="text-sm text-gray-500">
                          {groupLocations.length} propert
                          {groupLocations.length === 1 ? "y" : "ies"} available
                        </span>
                            ...
                            <div className="relative h-64 lg:h-full overflow-hidden">
                              {!hasFailed ? (
                                <img
                                  ...
                                  loading="lazy"
                                  onError={() =>
                                    handleImageError(location._id, mainImageUrl)
                                  }
                                />
                              ) : (
                            ...
                            <div className="flex flex-wrap gap-3 mb-6">
                              {location.capacityOfPersons && (
                                <div className="flex items-center gap-2 bg-blue-50 text-blue-800 px-3 py-1.5 rounded-full text-sm font-medium">
                                  ...
                                  <span>
                                    {location.capacityOfPersons} guests
                                  </span>
                                </div>
                              )}
                              {location.propertyDetails?.bedrooms && (
                                <div className="flex items-center gap-2 bg-green-50 text-green-800 px-3 py-1.5 rounded-full text-sm font-medium">
                                  <Sun className="w-3.5 h-3.5" />
                                  <span>
                                    {location.propertyDetails.bedrooms} bedrooms
                                  </span>
                                </div>
                              )}
