...
const bookingSteps = [
  {
    number: "01",
    title: "Finalize the Location",
    description: "Choose from our exclusive properties",
  },
  {
    number: "02",
    title: "Check Availability",
    description: "View real-time availability calendar",
  },
  {
    number: "03",
    title: "Fill the form with easy steps",
    description: "Simple and secure booking process",
  },
  {
    number: "04",
    title: "Pay token amount for confirmation",
...
const BookingMadeEasy = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-12 sm:py-20 lg:py-28 bg-gradient-to-br from-[#f8faf9] to-white"
    >
          ...
          <div className="w-full lg:w-1/2 flex flex-col justify-center space-y-8 sm:space-y-12 order-2 lg:order-1">
            <div>
              ...
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed">
                You can now book Resort in most easiest way! Just follow the
                below steps and you are done with your booking.
              </p>
            </div>
