...
import { Waves, Clock, Users, ArrowRight, CheckCircle2, MapPin } from 'lucide-react';
  ...
  const sessions = [
    {
      ...
      startTime: "08:00 AM",
      endTime: "02:00 PM",
      description: "Start your day with a refreshing splash and bright morning vibes.",
      icon: "☀️"
    },
    {
      ...
      startTime: "03:00 PM",
      endTime: "09:00 PM",
      description: "Perfect for sunset gatherings and beautiful evening lighting.",
      icon: "🌙"
    },
    {
      ...
      startTime: "08:00 AM",
      endTime: "08:00 PM",
      description: "The ultimate experience for all-day celebrations and maximum fun.",
      icon: "🌊"
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center justify-center gap-2 bg-[#008DDA]/10 text-[#008DDA] px-4 py-1.5 rounded-full mb-4">
            ...
            <span className="text-sm font-bold uppercase tracking-widest">Premium Experience</span>
          </div>
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
            Make a splash at your next celebration. Choose from our flexible session timings designed to fit your event perfectly.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {sessions.map((session, index) => (
            ...
            >
              ...
              <p className="text-gray-600 mb-6 line-clamp-2">{session.description}</p>
              ...
              <div className="border-t border-gray-200 pt-6">
                <ul className="space-y-2 mb-6">
                  {['Private Access', 'Change Rooms', 'Music Support'].map((item, i) => (
        ...
        <div className="bg-gray-900 rounded-[2.5rem] p-8 md:p-12 relative overflow-hidden text-center text-white shadow-2xl">
          ...
          <div className="relative z-10">
            <div className="inline-flex items-center justify-center gap-2 bg-[#008DDA]/20 text-[#008DDA] px-4 py-2 rounded-full mb-6">
              ...
              <span className="text-sm font-bold uppercase tracking-widest text-white">Location Details</span>
            </div>
            
            <h3 className="text-3xl md:text-4xl font-bold mb-4">Want to Book a Pool Party?</h3>
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
              Visit our Location page to find complete details about pool party bookings, pricing, availability, and amenities at each of our venues.
            </p>
            ...
            <p className="mt-8 text-sm text-gray-400">
              For immediate assistance or custom requirements, call us at <span className="text-white font-medium">+91 90990 48961</span>
            </p>
          </div>
        </div>
