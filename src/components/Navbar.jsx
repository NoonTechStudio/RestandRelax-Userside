...
function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 transition-all duration-300 ease-in-out">
      <div
        className={`container mx-auto px-4 sm:px-6 flex items-center justify-between transition-all duration-300 ${
        ...
        >
          <ul className="flex space-x-4 lg:space-x-8 text-base lg:text-lg text-black">
            <li>
              <Link
                to="/"
                className="hover:text-[#008DDA] transition-colors whitespace-nowrap"
              >
                Home
              </Link>
            </li>
            ...
            <ul className="flex flex-col space-y-6 text-l text-black">
              <li>
                <Link
                  to="/"
                  onClick={toggleMenu}
                  className="hover:text-[#008DDA] transition-colors"
                >
                  Home
                </Link>
              </li>
