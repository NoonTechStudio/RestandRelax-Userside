...
const LOCATIONS_DATA = [
  {
    ...
    description:
      "Nestled amidst nature’s embrace, only 8 km from Kapurai Chokdi and 15 km from Baroda city, Misty Woods offers a perfect blend of tranquility and luxury. Experience serene surroundings, fresh air, and world-class amenities.",
    image: mistywood,
  },
  {
    id: "2",
    ...
    city: "Padra, Vadodara",
    description:
      "Welcome to Swarg, Maru Gaam - Your 20-Acre Village-Style Resort Escape. Spread across 20 acres, Swarg, Maru Gaam is a serene haven where over 80% of the land is lush, landscaped greenery with 73 spacious units.",
    image: swarg,
  },
  {
    id: "3",
    ...
    description:
      "Welcome to Swarg, Maru Gaam - Your 20-Acre Village-Style Resort Escape. Featuring 73 spacious units from 4,000 to 8,000 sq.ft. The clubhouse and amenities ensure a comfortable and luxurious stay for your entire group.",
    image: Ambawadi,
  },
  {
    id: "4",
    ...
    description:
      "A premium stay experience featuring wide open garden views and private sit-outs. Perfect for families looking for a peaceful weekend getaway away from the city noise while enjoying resort-style hospitality.",
    image: Riverfront,
  },
];
    ...
    <section className="py-20 sm:py-28 bg-gradient-to-b from-gray-50 to-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-16 sm:mb-24">
        ...
        <p className="mt-4 text-justify sm:text-center text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Explore our curated collection of world-class properties, each
